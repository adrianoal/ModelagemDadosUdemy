...
CREATE INDEX agenda_curso__idxv3 ON
    agenda_curso (
        curso_curso_id
    ASC );
...
CREATE TABLE agenda_curso_aluno (
    ...
    aluno_aluno_id                NUMBER(18) NOT NULL
);
...
ALTER TABLE curso ADD CONSTRAINT curso_codigo_uk UNIQUE ( codigo );
...
ALTER TABLE instrutor_curso ADD CONSTRAINT
instrutor_curso_instrutor_id_curso_id_un UNIQUE ( instrutor_instrutor_id,
                                                                                             curso_curso_id );
...
CREATE TABLE telefone (
    ...
    aluno_aluno_id              NUMBER(18),
    tipo_telefone_tipo_fone_id  NUMBER(3) NOT NULL
);

ALTER TABLE telefone ADD CONSTRAINT telefone_pk PRIMARY KEY ( telefone_id );

CREATE TABLE tipo_telefone (
    tipo_fone_id   NUMBER(3) NOT NULL,
    tipo_telefone  VARCHAR2(20) NOT NULL
);

ALTER TABLE tipo_telefone ADD CONSTRAINT tipo_telefone_pk PRIMARY KEY ( tipo_fone_id );
...
ALTER TABLE telefone
    ADD CONSTRAINT telefone_tipo_telefone_fk FOREIGN KEY ( tipo_telefone_tipo_fone_id )
        REFERENCES tipo_telefone ( tipo_fone_id );
