...
--------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------             
Seção 28:Oracle 19c SQL Fundamentos - Utilizando o SQL*PLUS

77.Utilizando o SQL*PLUS 

 Conectando ao Oracle utilizando o SQL*PLUS:
 -------------------------------------------
 
 CMD -- Para acessao o prompt de comando do Windows, ou no terminal do sistema q estiver usando.
 
 Digitar o seguinte comando:
 
  sqlplus username/password@stringdeconexao
